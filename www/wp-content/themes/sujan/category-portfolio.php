...
<section class="main text-center">
    <div class="container">
        <div class="heading">
            ...
            <p>This is a HTML CSS &amp; JavaScript portfolio filter, You can call this sorting images by category order. The layout design is based on Bootstrap. This Example &amp; Source Code By <a href="https://webdevtrick.com">Webdevtrick</a></p>
        </div>
        <ul class="list-unstyled row">
            <li class="col-md active" data-class="all">ALL</li>
            <!-- Display categories dynamically from WordPress -->
            <?php
            $categories = get_categories();
            foreach ($categories as $category) {
                echo '<li class="col-md" data-class="' . $category->slug . '">' . $category->name . '</li>';
            }
            ?>
        </ul>
        <div class="container-fluid">
            <div class="row">
                <!-- Display portfolio items dynamically from WordPress -->
                <?php
                $args = array(
                    'post_type' => 'ss_portfolio', // Change 'portfolio' to your custom post type
                    'posts_per_page' => -1,
                );
                ...
                ?>
                    <div class="col-md-3 images <?php echo $category_classes; ?>">
